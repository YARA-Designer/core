...
log_level_name = list(LOG_LEVELS.keys())[list(LOG_LEVELS.values()).index(int(INITIAL_CONFIG["log_level"]))]
...
if INITIAL_CONFIG["log_to_file"] is False:
    ...
    port = INITIAL_CONFIG["logging_port"]
...
logger = create_logger('YaraWhitelistRuleCreator')
